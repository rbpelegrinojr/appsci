...
<?php $resRChapter = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM research_chapters_tbl WHERE research_chapter_id = '{$_REQUEST['c_id']}'"));
		...
		<div class="white_card_header">
			<div class="box_header m-0">
				<div class="main-title">
					<h3 class="m-0">View Chapter for Research <?php echo $resResearch['research_title']; ?></h3>
				</div>
			</div>
		</div>

		<div class="white_card_body">
			<a href="pending_chapters.php?r_id=<?php echo $resResearch['research_id']; ?>" class="btn btn-primary">Back</a><br><br>
			<form action="edit_chapter_view.php?r_c_id=<?php echo $resRChapter['research_chapter_id']; ?>" method="POST" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="mb-3 col-md-4">
						...
						<input type="text" name="chapter_title" class="form-control" aria-describedby="emailHelp" placeholder="Type Here..." required="" value="<?php echo $resRChapter['chapter_title']; ?>" readonly>
					</div>
					<div class="mb-3 col-md-4">
						<label class="form-label" for="exampleInputEmail1">Chapter</label>
						<select class="form-control" name="chapter_no" required="" readonly>
					...
					<div class="mb-3 col-md-4">
						...
						<br>
						<a href="<?php echo $resRChapter['chapter_file']; ?>" target="_blank" class="btn btn-info">Download</a>
					</div>
				</div>
				<div class="mb-3">
					<label class="form-label" for="exampleInputPassword1"><b>Abstract</b></label>
					<textarea readonly="" id="Abstract_editor" name="chapter_abstract"><?php echo $resRChapter['chapter_abstract']; ?></textarea>
				</div>
			</form>
		</div>
	</div>
