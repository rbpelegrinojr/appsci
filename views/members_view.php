	...
	<div class="col-12">
		<div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
			<div class="page_title_left d-flex align-items-center">
				<h3 class="f_s_25 f_w_700 dark_text mr_30">My Members</h3>
				<ol class="breadcrumb page_bradcam mb-0">
					<li class="breadcrumb-item"><a href="our_research_view.php">Home</a></li>
					<li class="breadcrumb-item active">My Members</li>
				</ol>
			</div>
		...
		<div class="white_card_body">
			...
			<div class="table-responsive">
				<table class="table" id="myTable">
					...
					<tbody>
						<?php
						$query = mysqli_query($con, "SELECT * FROM members_tbl WHERE group_id = '{$resInfo['group_id']}' AND school_batch = '{$resInfo['school_batch']}' AND account_status = '1' AND member_id != '{$resInfo['member_id']}'");
