...
<div class="col-lg-12">
	<div class="white_card card_height_100 mb_30">
		...
		<div class="white_card_body">
			...
			<form action="edit_research_pending_view.php?r_id=<?php echo $_REQUEST['r_id']; ?>" method="POST" enctype="multipart/form-data">
				...
				<input type="submit" name="btnEditResearch" class="btn btn-primary col-md-12" value="EDIT">
			</form>
		</div>
	</div>
</div>
