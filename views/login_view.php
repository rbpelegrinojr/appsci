                ...
                <div class="row m-t-25 text-left">
                  <div class="col-12">
                    ...
                    <div class="forgot-phone text-right f-right">
                      <a href="register_view.php" class="text-right f-w-600"> Sign Up</a><!--  / <a href="forgot_pass.php" class="text-right f-w-600"> Forgot Password?</a> -->
                    </div>
                  </div>
                </div>
                <div class="row m-t-30">
                  <div class="col-md-12">
                    <input type="submit" value="Sign in" name="btnStudLogin" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">
                  </div>
                </div>
                <hr />
                <div class="row">
