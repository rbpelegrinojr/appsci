<!-- Footer Start -->
        ...
        <a onclick="history.back()" class="btn btn-lg btn-primary btn-lg-square back-button">
            <i class="bi bi-arrow-left"></i>
        </a>
        <a onclick="history.forward()" class="btn btn-lg btn-primary btn-lg-square for-button">
