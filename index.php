<?php include 'header.php'; ?>
        ...
        <div class="container-fluid p-0">
            <div class="owl-carousel header-carousel position-relative">
                <div class="owl-carousel-item position-relative">
				    <img class="img-fluid" src="images/appsci.jpg" alt="">
				    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
				        <div class="container">
				            <div class="row justify-content-start">
				                <div class="col-10 col-lg-8">
				                    <h1 class="display-3 text-white animated slideInDown mb-4">Interactive Learning Made Easy</h1>
				                    <p class="fs-5 fw-medium text-white mb-4 pb-2">Explore engaging modules designed to enhance your understanding of applied sciences through hands-on activities and real-world examples.</p>
				                </div>
				            </div>
				        </div>
				    </div>
				...
				<div class="owl-carousel-item position-relative">
				    <img class="img-fluid" src="images/appsci2.jpg" alt="">
				    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
				        <div class="container">
				            <div class="row justify-content-start">
				                <div class="col-10 col-lg-8">
				                    <h1 class="display-3 text-white animated slideInDown mb-4">Discover, Learn, and Grow</h1>
				                    <p class="fs-5 fw-medium text-white mb-4 pb-2">Our learning platform empowers students to deepen their knowledge, collaborate with peers, and achieve academic success in a supportive environment.</p>
				                </div>
				            </div>
				        </div>
				    </div>
		...
		<div class="container-xxl py-5">
		    <div class="container">
		        <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Current Modules</h1>
