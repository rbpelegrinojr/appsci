            ...
            <div class="col-12">
                <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                    <div class="page_title_left d-flex align-items-center">
                        <h3 class="f_s_25 f_w_700 dark_text mr_30">Applications</h3>
                    ...
                    <div class="white_card_header">
                        <div class="box_header m-0">
                            <div class="main-title">
                                <h3 class="m-0">Pending Applications</h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($con, 
                                        "SELECT r.requirement_id, m.fname, m.mname, m.lname, m.contact_no, m.email, 
                                        ...
                                        JOIN rankings rk ON r.member_id = rk.user_id
                                        WHERE r.applicant_status = 0 AND r.job_id = '{$_REQUEST['j_id']}'
                                        ORDER BY rk.total_score DESC"
                                    );
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['total_score']; ?></td> <!-- Total Score Column -->
                                        <td>
                                            <a href="#" onclick="updateStatus(<?php echo $row['requirement_id']; ?>, 1);"><span class="badge rounded-pill bg-primary">Approve</span></a>
                                            <a href="#" onclick="updateStatus(<?php echo $row['requirement_id']; ?>, 3);"><span class="badge rounded-pill bg-danger">Cancel</span></a>
                                        </td>
                                    </tr>
                                    <?php
                                    }
