...
$resResearch = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM archive_research_tbl WHERE selected_group_id = '{$rS['selected_group_id']}' AND group_id = '{$rS['group_id']}' AND batch_year = '2022' ORDER BY archive_research_id DESC"));

if ($rows = mysqli_num_rows(mysqli_query($con, "SELECT * FROM archive_research_tbl WHERE selected_group_id = '{$rS['selected_group_id']}' AND group_id = '{$rS['group_id']}' AND batch_year = '2022'")) > 0) {
