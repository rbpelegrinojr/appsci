		...
		<div class="white_card_header">
			<div class="box_header m-0">
				<div class="main-title">
					<h3 class="m-0">Student Research</h3>
				</div>
			</div>
		</div>
					...
					<tbody>
						...
						while ($row = mysqli_fetch_assoc($query)) {
							...
							<tr>
								...
								<td>
									<a href="#" data-bs-toggle="modal" data-bs-target="#view_research_member<?php echo $row['archive_research_id']; ?>" style="color: white;"><span class="badge rounded-pill bg-primary">View</span></a>

									<div class="modal fade" id="view_research_member<?php echo $row['archive_research_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								...
								<td><?php echo $row['research_date_created']; ?></td>
								<td><a href="student_research_view.php?r_id=<?php echo $row['archive_research_id']; ?>"><span class="badge rounded-pill bg-primary">View</span></a></td>
							</tr>
							<?php
						}
						?>
